...
?>
    ...
    <nav class="navbar navbar-expand-lg" id="nav">
        ...
        <?php $codigo = $_GET["idCampus"]; 
        
        include_once("conexao.php");
        $sql = "SELECT * FROM table_campus WHERE idCampus = '$codigo'";
        $result = $conexao->query($sql);

        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                $campus = $row['nomeCampus'];?>

                <div class="container">
                    <div class="row" id="topico">
                        <?php echo "<h5 class='titulo'>" .$row['nomeCampus']. "</h5>"; ?>
                            <div class="col-12 col-md-6">
                                <?php echo "<img src='".$row['imgCampus']."' alt=''>"; ?>
                            </div>
    
                            <div class="col-6">
                                <?php echo "<iframe src='".$row['mapaCampus']."' width='600' height='300' style='border:0;' allowfullscreen='' loading='lazy'></iframe>"; ?>
                            </div>
                    </div>
        
                    <div class="row" id="detalhes">
                        <div class="col-6">
                            <?php echo "<p> Endereço: ".$row['enderecoCampus']." </p>"; ?>
                        </div>
        
                        <div class="col-6">
                            <?php echo "<p> Telefone: ".$row['telefoneCampus']."</p>"; ?>   
                        </div>
                    </div>
                </div>
        <?php
        ...
        <div class="container">
            ...
            <?php
                $sqli = "SELECT * FROM table_cursos WHERE campusCurso LIKE '%$campus%'";
                ...
                if ($resultado->num_rows > 0) {
                    ...
                    <div class="container">
                        <div class="row cursos">
                            ...
                            <div class="col-4">
                                <h4> Detalhes: </h4>
                                <?php echo "<p> Duração: " .$dados['duracaoCurso']. "</p>"; ?>
                                <?php echo "<p> Carga Horária: " .$dados['horasCurso']. "</p>"; ?>
